...
The latter is used if I to clarify or expand on my written answer.
...
2. Model checking and evaluation
3. Baysian regression - linear and ridge regression
4. The Dirichlet multinomial
5. The Dirichlet multinomial with a hierarchical uniform prior
...
3. [Pattern Recognition and Machine Learning](http://users.isr.ist.utl.pt/~wurmd/Livros/school/Bishop%20-%20Pattern%20Recognition%20And%20Machine%20Learning%20-%20Springer%20%202006.pdf) by Bishop
...
Ohter topics will be overfitting, generalization, bias/variance tradeoff and model selection.
For this I will be focusing on the introductory chapters of [Pattern Recognition and Machine Learning](http://users.isr.ist.utl.pt/~wurmd/Livros/school/Bishop%20-%20Pattern%20Recognition%20And%20Machine%20Learning%20-%20Springer%20%202006.pdf) by Bishop and [The Elements of Statistical Learning](https://web.stanford.edu/~hastie/Papers/ESLII.pdf) by Hastie et al..
